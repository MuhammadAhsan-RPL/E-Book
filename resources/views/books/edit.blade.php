...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 text-center bounce-in">
            <h1 class="text-5xl font-bold text-gradient-flow mb-4 animate-float-3d">✏️ Edit Buku ✏️</h1>
            <p class="text-gray-600 text-lg">Mengedit: <span class="font-semibold text-orange-600">{{ $book->judul }}</span></p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <textarea name="sinopsis" rows="4" 
                                      class="input-3d w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 transition-all">{{ $book->sinopsis }}</textarea>
                        </div>
                        ...
                        @if($book->image)
                        <div class="space-y-2 md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700">Cover Saat Ini</label>
                            <img src="{{ asset('storage/' . $book->image) }}" 
                                 alt="Current cover" 
                                 class="w-40 h-40 object-cover rounded-xl shadow-lg border-4 border-orange-200">
                        </div>
                        @endif

                        <!-- New Cover -->
                        <div class="space-y-3 md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700">Ganti Cover (opsional)</label>
